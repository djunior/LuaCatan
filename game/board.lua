local BoardTile = require "boardTile"
local LimitedValue = require"limitedValue"
local Vertex = require"vertex"
local ResourceTile = require"resourceTile"
...
local function createResourceTile(boardTile)
...
local function Board(levels)
    ...
    board.tiles[1] = createResourceTile(tile1)
    board.tiles[2] = createResourceTile(tile2)
    board.tiles[3] = createResourceTile(tile3)
    board.tiles[4] = createResourceTile(tile4)
    board.tiles[5] = createResourceTile(tile5)
    board.tiles[6] = createResourceTile(tile6)
    board.tiles[7] = createResourceTile(tile7)
